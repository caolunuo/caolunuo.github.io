    ...
    <div class="mdui-card rin-card">
        ...
        <div class="rin-card-part" id="fighting">
            ...
            <div class="mdui-container">
                <div class="mdui-row">
                    <div class="mdui-col-xs-12 mdui-col-sm-6 mdui-col-md-4" mdui-tooltip="{content: '无敌的男人'}">
                        <div class="mdui-container">
                    ...
                    <div class="mdui-col-xs-12 mdui-col-sm-6 mdui-col-md-4" mdui-tooltip="{content: '第二个六道'}">
                        <div class="mdui-container">
                            <div class="mdui-row mdui-valign">
                                <div class="mdui-col-xs-4">
                                    <div class="rin-card-content">
                    ...
                    <div class="mdui-col-xs-12 mdui-col-sm-6 mdui-col-md-4" mdui-tooltip="{content: '复制了上千种忍术'}">
                        <div class="mdui-container">
                            <div class="mdui-row mdui-valign">
                                <div class="mdui-col-xs-4">
                                    <div class="rin-card-content">
                ...
                <div class="mdui-row">
                    <div class="mdui-col-xs-12 mdui-col-sm-6 mdui-col-md-4" mdui-tooltip="{content:'0.5S打出10拳'}">
                        <div class="mdui-container">
                            速度
                            <div class="mdui-row mdui-valign">
                                <div class="mdui-col-xs-4">
                    ...
                    <div class="mdui-col-xs-12 mdui-col-sm-6 mdui-col-md-4" mdui-tooltip="{content: '最后只要胜利的人是我就好了'}">
                        <div class="mdui-container">
                            <div class="mdui-row mdui-valign">
                                <div class="mdui-col-xs-4">
                                    <div class="rin-card-content">
        ...
        <div class="rin-card-part" id="contact">
            ...
            <a class="mdui-btn mdui-btn-raised rin-btn rin-btn-black mdui-text-capitalize"
               href="https://github.com/caolunuo" target="_blank"><span class="iconfont icongithub"></span> Github</a>

            <a class="mdui-btn mdui-btn-raised rin-btn rin-btn-pink mdui-text-capitalize"
               href="https://space.bilibili.com/360368806" target="_blank"><span class="iconfont iconbilibili"></span>
                Bilibili</a>
            ...
            <a class="mdui-btn mdui-btn-raised rin-btn rin-btn-blue mdui-text-capitalize"
               href="https://qm.qq.com/cgi-bin/qm/qr?k=USVovZvqNTz4KNDF_v8gufyPrXy8oEpG&noverify=0
" target="_blank"><span class="iconfont iconmail_fill"></span> QQ</a>
        ...
        <div class="rin-card-part" id="last">
            <div class="rin-card-title2">曹宇@所谓觉悟就是在漆黑的荒野中开辟出一条应当前进的道路</div>
            <div class="rin-card-content">有胆量挑战我很了不起但是我只能夸赞你这一点了</div>
        </div>
